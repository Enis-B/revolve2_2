...
from jlo.RL_direct_tree.actor_critic_network import Actor, ActorCritic, Critic, ObservationEncoder
from jlo.RL_direct_tree.config import LR_ACTOR, LR_CRITIC, PPO_CLIP_EPS, LR_ACTOR, LR_CRITIC, N_EPOCHS, CRITIC_LOSS_COEFF, ENTROPY_COEFF, ACTOR_LOSS_COEFF
...
class RLcontroller(ActorController):
    ...
    def train(self, buffer: Buffer):
        ...
        torch.save(state, "RL_direct_tree/model_states/last_checkpoint")
